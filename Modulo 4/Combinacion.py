...
df_anual['Order Date'] = pd.to_datetime(df_anual['Order Date'], errors='coerce', format='%m/%d/%y %H:%M') # convertir la columna order date a formato de fecha y hora
...
df_anual['ISO_Year'] = df_anual['Order Date'].dt.isocalendar().year
df_anual['Month']    = df_anual['Order Date'].dt.month
